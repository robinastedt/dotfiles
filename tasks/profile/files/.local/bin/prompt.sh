...
cUHS=$WHITE # Color of the user and hostname separator, probably '@'
...
function promptcmd()
{
        ...
        if [[ $MPXC -gt $MPXT2 ]] ; then
                PS1="${PS1}${cBRACKETS}[${cMPX2}x:${MPXC}${cBRACKETS}]${cLINES}\342\224\200"
        elif [[ $MPXC -gt $MPXT1 ]] ; then
                PS1="${PS1}${cBRACKETS}[${cMPX1}x:${MPXC}${cBRACKETS}]${cLINES}\342\224\200"
        fi
